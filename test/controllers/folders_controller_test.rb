...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post folders_url, params: { folder: { name: @folder.name, permalink: @folder.permalink, user_id: @folder.user_id } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { name: @folder.name, permalink: @folder.permalink, user_id: @folder.user_id } }
